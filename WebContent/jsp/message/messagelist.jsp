...
//처음 페이지 로딩될때 실행됨
  ...
  function lastPosted(){   
   if(pstate == 0){ /*진행중이 아닐경우*/
    ...
    $.ajax({
     ...
     url  : "/message.do?method=getMessageListAjax",
  ...
  function goSearch() {
	  ...
	  document.form_search.action = "/message.do?method=getMessageList";
      ...
      <div class="row-fluid">
        ...
        <div class="tabbable"> <!-- Only required for left/right tabs -->
		  <ul class="nav nav-tabs">
			    ...
			    <li class="active"><a href="/message.do?method=getMessageList">받은 메세지</a></li>
