...
//처음 페이지 로딩될때 실행됨
  ...
  function lastPosted(){   
   if(pstate == 0){ /*진행중이 아닐경우*/
    ...
    $.ajax({
     ...
     url  : "/member.do?method=getWorkListAjax&cate=<%=req_cate%>&gubun=<%=gubun%>",
  ...
  function goSearch() {
	  ...
	  document.form_search.action = "/member.do?method=getWorkList&cate=<%=req_cate%>&gubun=<%=gubun%>";
      ...
      <div class="row-fluid">
        ...
        <div class="tabbable"> <!-- Only required for left/right tabs -->
		    <ul class="nav nav-tabs">
				...
				<%} %>
			    <li class="active"><a href="/member.do?method=getWorkList&gubun=<%=gubun%>">작업중인 프로젝트</a></li>
