...
<div class="container" align="center">
	<h1>회원가입 1/2<small>&nbsp;&nbsp;&nbsp;&nbsp;약관에 동의하여 주세요.</small>
	&nbsp;&nbsp;&nbsp;&nbsp;</h1>
</div>
</div>
<div class="container">
...
<form name="fregister" method="POST" onsubmit="return fregister_submit(this);" autocomplete="off" class="form-horizontal">
...
제1조(목적)
이 약관은 홈페이지(www.project24.co.kr)에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
...
부 칙 
(시행일) 이 약관은 2012년 7월 1일부터 시행합니다.                                                             </textarea></td>
        </tr>
        <tr> 
            <td width="98">
                &nbsp; <input type=radio value=1 name=agree id=agree11>&nbsp;동의합니다.
                &nbsp; <input type=radio value=0 name=agree id=agree10>&nbsp;동의하지 않습니다.
            </td>
        </tr>
    </table>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=10 readonly class=ed>&#039;project24&#039;은 (이하 &#039;회사&#039;는)
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)
        ...
        <tr> 
            <td height=40>
                &nbsp; <input type=radio value=1 name=agree2 id=agree21>&nbsp;동의합니다.
                &nbsp; <input type=radio value=0 name=agree2 id=agree20>&nbsp;동의하지 않습니다.
            </td>
        </tr>
    </table>
...
<div align="center">
            <button type="submit" id="btn_submit" class="btn btn-primary btn-large">저장하기</button>
...
function fregister_submit(f) 
{
    ...
    f.action = "/member.do?method=regist";
    return true;
}
